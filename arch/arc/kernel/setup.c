...
static char *arc_cpu_mumbojumbo(int cpu_id, char *buf, int len)
{
	...
	n += scnprintf(buf + n, len - n, "%s%s%s%s%s%s",
		...
		/*
		 * gcc 7.3.1 (GNU 2018.03) onwards generate unaligned accesses
		 * by default but -mno-unaligned-access to disable that didn't
		 * work until gcc 8.2.1 (GNU 2019.03).
		 * So landing here implies the interim period, when despite
		 * Kconfig being off, gcc is anyways generating unaligned
